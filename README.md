...
* A列 音のまま、かなをタイプ
* B列 音とおなじキーのシフト側(Aがシフト面ならノーマル側)をタイプ
* C列 表の別のかなをタイプ
...
**補足**:  梅棹式表記でも、「切る」と「着る」のように、1音の動詞でひらがなのままでは意味が判別しにくいときは、漢字の使用が許容されています。これらの動詞は、よみから漢字に変換する方法では、誤変換になることもおおく能率がよくありません。さいわい、こういった意味が判別しにくい1音の動詞はそれほどなく、上記の表のような漢字に限定されるようです。
　なお梅棹式では、意味の判別がむずかしくないものは、漢字をつかわずにひらがなでかきます。表のかっこ内の漢字は原則ひらがなをつかいます。また、「生む」と「産む」のように和語ではおなじものも、漢字でかきわけたりせずに、そのままひらがなで「うむ」とかきます。
...
**補足**: 明治時代から戦後まで50年にわたって日本の国語政策にたずさわられた保科孝一さん(1872-1955)は『国語問題五十年』(1949)のなかで、 おくりがなは「漢字や漢文を適当によむ場合の手引きという、いわば便宜的なものである。もしこれを学術的に送りがな法を制定しようなどと考えるのは、送りがなが便宜の上に立つものであることを知らないもので、いかに苦心してみたところで、一貫した法則で組み立てることができないものである。」とのべられています。梅棹式表記では、和語の用言は原則としてひらがなでかくので、こういった混乱はありません。

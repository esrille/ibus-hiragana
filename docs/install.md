...
2. [OSの入力ソースに￹追加￺ついか￻する](#input-source)
3. [「ひらがなIME」を￹有効￺ゆうこう￻にする](#enable)
4. [キーボードの￹種類￺しゅるい￻を￹指定￺してい￻する](#keyboard)
5. [Wayland￹用￺よう￻の￹設定￺せってい￻をする（GNOME 46よりまえのばあい）](#wayland)
...
## キーボードの￹種類￺しゅるい￻を￹指定￺してい￻する {: #keyboard}

...
commands:
  ...
  taigen ...
    output non-conjugating words with okurigana in all input files, excluding single-kanji taigen listed in jōyō kanji table
  union ...
    output all words in input files
  wago ...
    output native Japanese words in all input files
  yougen ...
    output conjugating words in all input files, excluding single-kanji yougen listed in jōyō kanji table
  yutou ...

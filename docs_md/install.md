...
4. [Wayland￹用￺よう￻の￹設定￺せってい￻をする](#wayland)
...
この￹機能￺きのう￻を￹有効￺ゆうこう￻にするには、つぎのようなものを￹追加￺ついか￻でインストールする￹必要￺ひつよう￻があります。
...
1. 「ひらがなIMEの￹設定￺せってい￻」ウィンドウで、「[￹変換￺へんかん￻￹候補￺こうほ￻の￹選択￺せんたく￻に￹大規模￺だいきぼ￻￹言語￺げんご￻モデルを￹利用￺りよう￻する](settings.html#llm)」を￹有効￺ゆうこう￻にする。

![「ひらがなIMEの設定」ウィンドウ](ibus-setup-hiragana_3.png)

2. [￹適用￺てきよう￻]をクリックすると、つぎのようなウィンドウがひらきます。

![ポストインストール ウィンドウ](postinst_1.png)

3. [インストール]をクリックすると、インストールがはじまり、そのログがウィンドウ￹内￺ない￻に￹表示￺ひょうじ￻されます。
...
　これでインストールは￹完了￺かんりょう￻しています。
ログインしなおすと、￹大規模￺だいきぼ￻￹言語￺げんご￻モデルを￹利用￺りよう￻した￹変換￺へんかん￻￹候補￺こうほ￻の￹選択￺せんたく￻￹機能￺きのう￻が￹利用￺りよう￻できるようになります。

<br>**￹注￺ちゅう￻**: 「ひらがなIME」は、<code>~/.local/share/ibus-hiragana/venv</code>にvenvをつくっています。tohoku-nlp/bert-base-japanese-v3のファイルは、<code>~/.cache/huggingface/hub/models--cl-tohoku--bert-base-japanese-v3/</code>のなかに￹保存￺ほぞん￻されています。

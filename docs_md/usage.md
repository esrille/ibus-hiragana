...
　トップバーのキーボードメニューから「ひらがなIMEについて...」をえらぶと、バージョン￹情報￺じょうほう￻ダイアログボックスが￹表示￺ひょうじ￻されます。

![キーボード メニュー](keyboard-menu.png)

<br>
　バージョン￹情報￺じょうほう￻ダイアログボックスでは、つぎのような￹情報￺じょうほう￻を￹確認￺かくにん￻できます。

- ひらがなIMEのバージョン￹番号￺ばんごう￻
- LLMおよびCUDAの￹使用￺しよう￻￹状況￺じょうきょう￻

![情報ダイアログボックス](about.png)

　[￹設定￺せってい￻ウィンドウ](settings.html#option)で、LLMの￹計算￺けいさん￻にCUDAを￹利用￺りよう￻するように￹設定￺せってい￻しているときは、つかっているGPUも￹確認￺かくにん￻できます。
